...
<body>
	...
	<ul>
		...
		<li>sessionScope.currentStudent.stduentName: ${ sessionScope.currentStudent.studentName }</li>
		<li>sessionScope.currentStudent.studentDept: ${ sessionScope.currentStudent.studentDept }</li>
	</ul>
</body>
</html>